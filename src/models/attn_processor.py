"""
Attention Processors for the diffusion model.
"""
...
class SkipAttnProcessor(torch.nn.Module):
    """Skip Cross-Attention Processor - returns hidden states unchanged."""
...
class AttnProcessor2_0(torch.nn.Module):
    ...
    def __init__(self, hidden_size=None, cross_attention_dim=None, **kwargs):
        ...
        if not hasattr(F, "scaled_dot_product_attention"):
            raise ImportError(
                "AttnProcessor2_0 requires PyTorch 2.0, please upgrade PyTorch."
            )
